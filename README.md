...
| [ORP-0010: Defect-sector Majorana spectrum](problems/ORP-0010-defect-sector-majorana-spectrum.md) | Quantum many-body dynamics | Closed-form expressions for the complete spectrum | Verify the characteristic-polynomial or terminating-recurrence identity, multiplicities, branches, and exceptional parameter cases |
